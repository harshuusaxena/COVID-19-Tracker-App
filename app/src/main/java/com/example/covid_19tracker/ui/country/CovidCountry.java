...
public class CovidCountry implements Parcelable {
    ...
    String mCovidCountry, mCases, mTodayCaes, mDeaths, mTodayDeaths, mRecovered, mActive, mCritical, mFlags;

    public CovidCountry(String mCovidCountry, String mCases, String mTodayCaes, String mDeaths, String mTodayDeaths, String mRecovered, String mActive, String mCritical, String mFlags) {
        this.mCovidCountry = mCovidCountry;
        this.mCases = mCases;
        this.mTodayCaes = mTodayCaes;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.mTodayCaes);
